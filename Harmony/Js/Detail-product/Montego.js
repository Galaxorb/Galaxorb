$(document).ready(function() {
    var images = [
        "../../Image/Detail_Img/Montego/png.png",
        "../../Image/Detail_Img/Montego/Montego+11.4''+Table+Lamp+with+USB (2).png",
        "../../Image/Detail_Img/Montego/Montego+11.4''+Table+Lamp+with+USB.png",
        "../../Image/Detail_Img/Montego/Montego+11.4''+Table+Lamp+with+USB (1).png",
    ];
